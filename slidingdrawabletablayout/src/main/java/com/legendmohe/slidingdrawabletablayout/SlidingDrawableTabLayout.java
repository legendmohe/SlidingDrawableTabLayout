...
public class SlidingDrawableTabLayout extends HorizontalScrollView {
    ...
    /**
     * Gravity used to lay out the tabs in the center of the {@link SlidingDrawableTabLayout}.
     *
     * @see #setTabGravity(int)
     * @see #getTabGravity()
     */
    ...
    /**
     * Returns the current mode used by this {@link SlidingDrawableTabLayout}.
     *
     * @see #setTabMode(int)
     */
    @Mode
...
//            }
     ...
     * necessary calls back to the provided {@link SlidingDrawableTabLayout} so that the tab position is
     * kept in sync.
     *
    ...
    public static class MyTabLayoutOnPageChangeListener implements ViewPager.OnPageChangeListener {
        ...
        public void onPageScrolled(int position, float positionOffset,
            ...
            final SlidingDrawableTabLayout tabLayout = mTabLayoutRef.get();
            if (tabLayout != null) {
    ...
    /**
     * A {@link SlidingDrawableTabLayout.OnTabSelectedListener} class which contains the necessary calls back
     * to the provided {@link ViewPager} so that the tab position is kept in sync.
     */
    public static class ViewPagerOnTabSelectedListener implements SlidingDrawableTabLayout.OnTabSelectedListener {
